...
const base_url = "https://mint-signer.tigerworlds.io/minter-public/" //"https://mint-signer.tigerworlds.io/minter-public/"
...
async function getMaxMints() {
    var url = "https://mint-signer.tigerworlds.io/minter-public/get-mint-allowed";
...
async function getSignature() {
    var url = "https://mint-signer.tigerworlds.io/minter-public/get-sign";
    var xhr = new XMLHttpRequest();
    xhr.open("POST", url);
    xhr.setRequestHeader("Content-Type", "application/json");
    xhr.onreadystatechange = function () {
